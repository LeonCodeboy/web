...
if(isset($_GET['id'])){
	...
	$type_arr_desc = array('',"Администратор","Преподаватель","Студент");
...
<div class="container-fluid">
	<div class="card card-widget widget-user shadow">
      ...
      <div class="widget-user-image">
      	...
      	<?php else: ?>
        <img class="img-circle elevation-2" src="assets/uploads/<?php echo $avatar ?>" alt="Аватарка пользователя"  style="width: 90px;height:90px;object-fit: cover">
      	<?php endif ?>
      </div>
      <div class="card-footer">
        <div class="container-fluid">
        	<dl>
        		<dt>Роль</dt>
        		<dd><?php echo $type_arr_desc[$type] ?></dd>
        	</dl>
        </div>
    </div>
	</div>
